...
namespace Services
{
    public class DataShaper<T> : IDataShaper<T> where T : class
    {
        ...
        {
            var requiredFields = GetRequiredProperty(fieldString);
            return FetchData(entities, requiredFields);
        }

        public ShapedEntity ShapeData(T entity, string fieldString)
        {
            var requiredProperties = GetRequiredProperty(fieldString);
            return FetchDataForEntity(entity, requiredProperties);
        }

        private IEnumerable<PropertyInfo> GetRequiredProperty(string fieldsString)
        {
